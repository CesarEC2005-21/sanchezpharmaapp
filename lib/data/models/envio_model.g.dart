...
EnvioModel _$EnvioModelFromJson(Map<String, dynamic> json) => EnvioModel(
  ...
  latitudDestino: EnvioModel._coordenadaFromJson(json['latitud_destino']),
  longitudDestino: EnvioModel._coordenadaFromJson(json['longitud_destino']),
  latitudRepartidor: EnvioModel._coordenadaFromJson(json['latitud_repartidor']),
  longitudRepartidor: EnvioModel._coordenadaFromJson(
    json['longitud_repartidor'],
  ),
